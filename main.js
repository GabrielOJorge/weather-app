/******/ (() => {
  ...
  \******************************************/
      /***/ (
        ...
        /* harmony import */ var _weather_searcher__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../weather-searcher */ "./src/components/weather-searcher/index.js"
          );
        ...
        const setBtnEvent = (lat, lon) => {
          ...
          unitBtns.forEach((btn) => {
            btn.addEventListener("click", () =>
              (0, _weather_searcher__WEBPACK_IMPORTED_MODULE_0__["default"])(
                lat,
                lon,
                btn.value
              )
  ...
  \**************************************************/
      /***/ (
        ...
        /* harmony import */ var _js_functions_getWeatherIcon__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../../js/functions/getWeatherIcon */ "./src/js/functions/getWeatherIcon.js"
          );
        /* harmony import */ var _js_functions_displayResponses__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../../js/functions/displayResponses */ "./src/js/functions/displayResponses.js"
          );
        /* harmony import */ var _js_functions_getTime__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../../js/functions/getTime */ "./src/js/functions/getTime.js"
          );
        ...
        const displayWeatherData = async (lat, lon, units = "metric") => {
          ...
          _js_functions_getTime__WEBPACK_IMPORTED_MODULE_2__["default"])();
          ...
          tempIcon.className = (0,
          _js_functions_getWeatherIcon__WEBPACK_IMPORTED_MODULE_0__["default"])(
            weatherData.icon
          );
        };
        ...
        unitBtns.forEach((btn) => {
          btn.addEventListener("click", () => {
            const currentCoords = (0,
            _js_functions_displayResponses__WEBPACK_IMPORTED_MODULE_1__.getCurrentCoords)();
        ...
        form.addEventListener("submit", (e) => {
          e.preventDefault();
          (0,
          _js_functions_displayResponses__WEBPACK_IMPORTED_MODULE_1__.displayResponses)();
        });
  ...
  \**********************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ displayResponses: () =>
            /* binding */ displayResponses,
          /* harmony export */ getCurrentCoords: () =>
            /* binding */ getCurrentCoords,
          /* harmony export */
        });
        /* harmony import */ var _components_weather_searcher__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../../components/weather-searcher */ "./src/components/weather-searcher/index.js"
          );
        /* harmony import */ var _js_functions_getLocations__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../../js/functions/getLocations */ "./src/js/functions/getLocations.js"
          );

        let currentLat = 51.50853;
        let currentLon = -0.12574;
        ...
        const displayResponses = async () => {
          ...
          const locations = await (0,
          _js_functions_getLocations__WEBPACK_IMPORTED_MODULE_1__["default"])(
            location
          );
          const locationsResponses = document.querySelector(
            ".locations-responses"
          );
          ...
          locations.forEach(() =>
            locationsResponses.append(createResponseDiv())
          );
          ...
          responses.forEach((response, index) => {
            ...
            response.addEventListener("click", () => {
              ...
              (0,
              _components_weather_searcher__WEBPACK_IMPORTED_MODULE_0__[
                "default"
      ...
      /***/ (
        ...
        const getLocations = async (location) => {
          const geoCode = await fetch(
            `https://api.openweathermap.org/geo/1.0/direct?q=${location}&limit=5&appid=c0ce5c434457e791f019f4b386f41af3`,
            { mode: "cors" }
          );
  ...
  \*************************************/
      /***/ (
        ...
        const getDateTime = () => {
          ...
          const formatedDateTime = new Intl.DateTimeFormat(
            "en-US",
            options
          ).format(currentDate);
  ...
  \********************************************/
      /***/ (
        ...
        const getWeatherIcon = (icon) => {
          ...
          return iconsObj[lowerCaseIcon]
            ? iconsObj[lowerCaseIcon]
            : "fa-solid fa-smog";
        };
  ...
  \**********************/
    ...
    /* harmony import */ var _components_main_btn__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./components/main-btn */ "./src/components/main-btn/index.js"
      );
  })();
